...
public class SearchFeatureReq {
    ...
    public class Parameter {
        ...
        public class ParameterInner {
            public String func = "searchFea"; // 用于指定声纹的具体能力（创建声纹特征库值为createGroup）
            public String groupId = ""; // 特征的标识，长度最小为0，最大为32
            public int topK = 2; // 期望返回的特征数目,最大为10（要有足够的特征数量）
            public CreateGroupRes searchFeaRes = new CreateGroupRes();
