...
import com.zy.customer.databinding.CustomerActivityCountdownBinding
...
class CountdownActivity : AppCompatActivity(){
    ...
    private val binding by lazy { CustomerActivityCountdownBinding.inflate(layoutInflater)}
