...
import com.zy.demo.mydemo.view.MyListView;
...
/** 仿淘宝商品详情页的上下翻页 */
public class DoubleScrollViewDemo extends AppCompatActivity {
...
//	private CyclicRollView mViewPager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_double_scroll_view_demo);
		this.context = this;
