...
public class CyclicRollView extends FrameLayout {
     ...
     * 指示器距离底部的距离
     */
    private int mIndicatorBottomMargin = 10;
    ...
    public void setAdapter(CyclicViewAdapter<?> adapter) {
        ...
        int initPos = correctPosition(mInitPos);
        mViewPager.setCurrentItem(mAdapter.getViewCount() * 1000 + initPos);//偏移
        
        sendMsg2Switch();
        
        mIndicatorLayout.initIndicators(mAdapter.getViewCount(), initPos);
    }
...
//        if (mAdapter == null || mAdapter.getViewCount() < 0) {
//            return false;
//        }
//        if (index >= 0 && index < mAdapter.getViewCount()) {
//            return true;
//        }
//        return false;
//    }
    ...
    private class InnerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (isAutoSwitch && msg.what == MSG_NEXT) {
