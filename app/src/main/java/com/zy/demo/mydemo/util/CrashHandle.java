...
//		String addDate = formatter.format(curDate);
//		LogDAO dao = new LogDAO(mContext);
//		LogInfo infoLog = new LogInfo();
//		infoLog.setLogMsg(msg);
//		infoLog.setMechinecode(Mechine.GetMechineId(mContext));
//		infoLog.setOperatorType(ServiceTools.Catch_SysUnCatch);
//		infoLog.setUploadStatus(0);
//		infoLog.setUserName(userName);
//		infoLog.setAddDate(addDate);
//		dao.Insert(infoLog);
